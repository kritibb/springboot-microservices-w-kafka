...
public class KafkaConsumerConfiguration {
    ...
    //if we simply used application.properties file to add kafka properties: Spring Boot would:
    //
    //read these properties
    //bind them to KafkaProperties
    //create a default ConsumerFactory
    //wire it into a KafkaListenerContainerFactory; so bottom two beans wouldn't be needed
    @Bean
...
//        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JacksonJsonDeserializer.class);
        ...
        //make consumer read message from the beginning of a partition
    ...
    ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory(ConsumerFactory<String, Object>
                                                                                                  consumerFactory, KafkaTemplate<String, Object> kafkaTemplate) {
